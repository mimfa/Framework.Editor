...
namespace MiMFa.Controls.WinForm.Editor.Model
{
    ...
    public abstract class UndoableCommand : Command
    {
        ...
        {
            bool b = sel.Start.LineIndex < lastSel.Start.LineIndex;
            if (invert)
            {
                if (b)
                    ts.OnTextChanged(sel.Start.LineIndex, sel.Start.LineIndex);
                else
                    ts.OnTextChanged(sel.Start.LineIndex, lastSel.Start.LineIndex);
            }
            else
            {
                if (b)
