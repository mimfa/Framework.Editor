...
namespace MiMFa.Controls.WinForm.Editor.Model
{
    ...
    public class FileTextSource : TextSource, IDisposable
    {
        ...
        public FileTextSource(EditBox currentTB)
            : base(currentTB)
        {
        ...
        private void UnloadUnusedLines()
        {
            ...
            var iStartVisibleLine = CurrentTB.VisibleRange.Start.LineIndex;
            var iFinishVisibleLine = CurrentTB.VisibleRange.End.LineIndex;
