...
namespace MiMFa.Controls.WinForm.Editor.Model
{
    ...
    public class ImageVisualMarker : VisualMarker
    {
        public Image Image { get; set; }
        public ImageVisualMarker(Image image, Rectangle rectangle)
            : base(rectangle)
        {
            Image = image;
        }
        ...
        {
            gr.FillRectangle(new TextureBrush(this.Image), rectangle);
